              ...
              <div class="header_inner">
                ...
                <div class="right-side lg:pr-4">
                 ...
                 mr-1 opacity-90 text-xl uilus-circle"
                    ...
                    <div class="flex justify-center flex-center text-center dark:text-gray-300">
                      <div class="flex flex-col choose-upload text-center">
                        ...
                        <p class="my-3 leading-6">
                          {" "}
                          Do you have a video wants to share us <br /> please
                          upload her ..
                        </p>
                        <div uk-form-custom>
                          <input type="file" />
                      ...
                      <div class="uk-flex uk-flex-column choose-upload" hidden>
                        ...
                        <p class="my-3 leading-6">
                          {" "}
                          Import videos from YouTube <br /> Copy / Paste your
                          video link here{" "}
                        </p>
                        <form class="uk-grid-small" uk-grid>
                          ...
                          <div class="uk-width-auto">
                            ...
                            <button
                              type="submit"
                              class="button soft-warning -ml-2"
                            >
                              Import{" "}
                            </button>{" "}
                          </div>
                    ...
                    <ul class="dropdown_scrollbar" data-simplebar>
                      ...
                      <li>
                        <a href="#">
                          ...
                          <div class="drop_content">
                            <p>
                              <strong>Stella Johnson</strong> Nonummy nibh
                              euismod
                      ...
                      <li>
                        <a href="#">
                          ...
                          <div class="drop_content">
                            <p>
                              <strong>Alex Dolgove</strong> Lorem ipsum dolor
                              cursus
                              <span class="text-link">
                                {" "}
                                Adipiscing massa convallis{" "}
                      ...
                      <li>
                        <a href="#">
                          ...
                          <div class="drop_content">
                            ...
                            <p>
                              {" "}
                              Sediam nonummy nibh euismod tincidunt laoreet
                              dolore{" "}
                            </p>
                          </div>
                        </a>
                  ...
                  <a href="#">
                    <img
                      src="/images/avatars/avatar-0.jpg"
                      class="header-avatar"
                      alt=""
                    />
                  </a>
